...
./scripts/run.py ./experiments/overhead/BothApplicationsOverheadByNSamples.yaml -d "$DURATION" -r "$REPS" -c "$DATE_CODE"

cmd="./reproduce/plot.py --path \"data/output/$EXPERIMENT_FOLDER\" --plot overhead_CI"
