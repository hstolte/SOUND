...
./scripts/run.py ./experiments/overhead/SmartGridAnomalyOverhead.yaml -d "$DURATION" -r "$REPS" -c "$DATE_CODE"

cmd="./reproduce/plot.py --path \"data/output/$EXPERIMENT_FOLDER\" --plot time-series"
