...
./scripts/run.py ./experiments/checkresults/SmartGridAnomalyCheckResultCICase.yaml -d "$DURATION" -r "$REPS" -c "$DATE_CODE"



cmd="./reproduce/plot_checkresult.py --path \"data/output/$EXPERIMENT_FOLDER\" --plot CI"
