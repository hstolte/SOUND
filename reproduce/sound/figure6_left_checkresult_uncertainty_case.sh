...
./scripts/run.py ./experiments/checkresults/SmartGridAnomalyCheckResultUncertaintyCase.yaml -d "$DURATION" -r "$REPS" -c "$DATE_CODE"



cmd="./reproduce/plot_checkresult.py --path \"data/output/$EXPERIMENT_FOLDER\" --plot value_uncertainty"
